function Navbar() {
  ...
  <a class="navbar-brand me-5" href="#">
    <img
      class="BrandLogo"
      src="./Images/purple mango full logo.png"
      alt=""
      srcset=""
    />
  </a>
  <ul class="navbar-nav d-none d-lg-flex">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#Pricing">Why Join us</a>
    </li>
    <li class="nav-item">
...
<div class="nav-right d-flex align-items-center">
  <div class="badges-items me- d-none d-sm-block">
    <a class="badge-item text-decoration-none" href="https://www.mq20trk.com/2RSFWK9X/7XDN2">
      <img
        class="item"
